...
window=sg.Window('miniprojet',layout,icon='Logonew.ico')
#dic={"AMAZON":"AMZN","FLIPKART":"FPKT","RELIANCE":"RELIANCE","META":"META","MAXLINEAR":"MXL"}
while True:
	...
	if event=='-A-':
		print('amazon')
		company="AMZN"
		#data=pd.read_csv('C:\\Users\\Likhith\\Desktop\\e3s2\\miniproject\\Amzn.csv')
		break
	if event=='-AA-':
		print('apple')
		company="AAPL"
		#data=pd.read_csv('C:\\Users\\Likhith\\Desktop\\e3s2\\miniproject\\Apl.csv')
		break
	if event=='-N-':
		print('Netflix')
		company='NFLX'
		#data=pd.read_csv('C:\\Users\\Likhith\\Desktop\\e3s2\\miniproject\\Ntflix.csv')
		break
	if event=='-Me-':
		print('Meta')
		company='META'
		#data=pd.read_csv('C:\\Users\\Likhith\\Desktop\\e3s2\\miniproject\\Meta.csv')
		break
	if event=='-Mx-':
		print('Maxilinear')
		company='MXL'
		#data=pd.read_csv('C:\\Users\\Likhith\\Desktop\\e3s2\\miniproject\\Mxl.csv')
		break			
...
window['-result-'].update(f'Predicted stock Price of {company}: {" Rs. "+str(prediction[0])[1:6]}')
while True:
	event,values=window.read()
